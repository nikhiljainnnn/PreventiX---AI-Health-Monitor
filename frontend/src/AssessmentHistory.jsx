...
const AssessmentHistory = () => {
  ...
  const getRiskCategoryColor = (category) => {
    if (category === 'Low Risk') return 'bg-green-100 text-green-800';
    if (category === 'Moderate Risk') return 'bg-yellow-100 text-yellow-800';
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Assessment History</h1>
          <p className="text-gray-600 mt-2">View all your health assessments and track your progress over time.</p>
          <div className="mt-4 flex items-center gap-4 text-sm text-gray-600">
            <span>Total Assessments: <span className="font-semibold text-gray-900">{assessments.length}</span></span>
            <span>•</span>
            <span>Latest: <span className="font-semibold text-gray-900">{assessments[0]?.date || 'N/A'}</span></span>
          </div>
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-gray-900">{assessment.date}</span>
                  {getTrendIcon(trend)}
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-900">Detailed Health Report</h2>
                <button
                  onClick={() => {
              ...
              <p className="text-gray-600 mt-2">Assessment from {selectedAssessment.date}</p>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-blue-900">{selectedAssessment.overall_score}</div>
                  <div className="text-sm text-blue-700">Health Status</div>
                </div>
                
                <div className="bg-green-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Heart className="w-5 h-5 text-green-600" />
                    <span className="font-semibold text-green-900">Cardiovascular</span>
                  </div>
                  <div className="text-2xl font-bold text-green-900">{selectedAssessment.cardiovascular_health_score}</div>
                  <div className="text-sm text-green-700">Heart Health</div>
                </div>
                
                <div className="bg-purple-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <TrendingUp className="w-5 h-5 text-purple-600" />
                    <span className="font-semibold text-purple-900">Metabolic</span>
                  </div>
                  <div className="text-2xl font-bold text-purple-900">{selectedAssessment.metabolic_health_score}</div>
                  <div className="text-sm text-purple-700">Metabolism</div>
                </div>
              </div>
