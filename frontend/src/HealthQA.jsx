...
const HealthQA = ({ healthData, onClose }) => {
  ...
  console.log('HealthQA assessmentId:', assessmentId);
          ...
          {conversation.length === 0 ? (
            <div className="text-center py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
                ...
                <button
                  onClick={() => setQuestion("How can I improve my blood pressure?")}
                  className="p-3 text-left bg-green-50 hover:bg-green-100 rounded-lg transition-colors text-sm"
                >
                  ❤️ "How can I improve my blood pressure?"
                </button>
                <button
                  onClick={() => setQuestion("What diet changes should I make?")}
                  className="p-3 text-left bg-yellow-50 hover:bg-yellow-100 rounded-lg transition-colors text-sm"
                >
                  🥗 "What diet changes should I make?"
                </button>
                <button
                  onClick={() => setQuestion("What exercise routine is best for me?")}
                  className="p-3 text-left bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors text-sm"
                >
                  🏃 "What exercise routine is best for me?"
                </button>
              </div>
            </div>
          ) : (
