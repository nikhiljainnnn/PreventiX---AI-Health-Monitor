...
const HealthAssessment = () => {
  ...
  const getRiskColor = (risk) => {
    if (risk < 0.25) return 'text-green-600 bg-green-50 border-green-200';
    if (risk < 0.5) return 'text-yellow-600 bg-yellow-50 border-yellow-200';
    if (risk < 0.75) return 'text-orange-600 bg-orange-50 border-orange-200';
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="p-6 bg-blue-50 rounded-xl">
                <p className="text-sm text-blue-600 font-semibold mb-2">Metabolic Health Score</p>
                <p className="text-3xl font-bold text-blue-900">{result.metabolic_health_score}</p>
              ...
              <div className="p-6 bg-purple-50 rounded-xl">
                <p className="text-sm text-purple-600 font-semibold mb-2">Cardiovascular Health Score</p>
                <p className="text-3xl font-bold text-purple-900">{result.cardiovascular_health_score}</p>
              ...
              <div className="space-y-4">
                {result.nutrition_recommendations?.primary && result.nutrition_recommendations.primary.length > 0 && (
                  <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                    <p className="font-semibold text-green-900 mb-2">Nutrition</p>
                ...
                {result.fitness_recommendations?.primary && result.fitness_recommendations.primary.length > 0 && (
                  <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                    <p className="font-semibold text-blue-900 mb-2">Fitness</p>
                    <ul className="space-y-1">
                ...
                {result.lifestyle_recommendations && result.lifestyle_recommendations.length > 0 && (
                  <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
                    <p className="font-semibold text-purple-900 mb-2">Lifestyle</p>
                    <ul className="space-y-1">
